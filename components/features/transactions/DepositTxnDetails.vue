  ...
  <div class="txn-details">
    ...
    <div class="direction">
      ...
      <div>
        <div class="summary pb-6">
          <div class="flex items-start border-b border-dashed border-b-surface-300 py-2">
            <p class="capitalize text-emphasis-medium text-sm leading-tight">To (Wallet)</p>
            <div class="flex space-y-2 flex-col items-end ml-auto text-emphasis-higher">
              <span class="text-sm font-bold uppercase">{{ toWalletName }}</span>
              <span class="uppercase font-bold text-emphasis-low"> {{ props.data.to_currency }}</span>
            </div>
          </div>
          <div class="flex items-start border-b border-dashed border-b-surface-300 py-2">
            <p class="capitalize text-emphasis-medium text-sm leading-tight">Source</p>
            <div class="flex space-y-2 capitalize flex-col ml-auto text-sm">
              {{ $slugToString(computedData.payin_method) }}
            </div>
          </div>
        </div>
      </div>
